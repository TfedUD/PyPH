...
def _UtilizationPattern_Ventilation(_obj):
    return [
        ...
        PyPH_WUFI.xml_node.XML_Node(
            "Maximum_DOS", _obj.utilizations.maximum.daily_op_sched
        ),
        PyPH_WUFI.xml_node.XML_Node(
            "Maximum_PDF", _obj.utilizations.maximum.frac_of_design_airflow
        ),
        PyPH_WUFI.xml_node.XML_Node(
            "Standard_DOS", _obj.utilizations.standard.daily_op_sched
        ),
        PyPH_WUFI.xml_node.XML_Node(
            "Standard_PDF", _obj.utilizations.standard.frac_of_design_airflow
        ),
        PyPH_WUFI.xml_node.XML_Node(
            "Basic_DOS", _obj.utilizations.basic.daily_op_sched
        ),
        PyPH_WUFI.xml_node.XML_Node(
            "Basic_PDF", _obj.utilizations.basic.frac_of_design_airflow
        ),
        PyPH_WUFI.xml_node.XML_Node(
            "Minimum_DOS", _obj.utilizations.minimum.daily_op_sched
        ),
        PyPH_WUFI.xml_node.XML_Node(
            "Minimum_PDF", _obj.utilizations.minimum.frac_of_design_airflow
        ),
    ]
    ...
    return [
        ...
        PyPH_WUFI.xml_node.XML_Node(
            *PyPH_WUFI.selection.Selection(
                "Assembly::Order_Layers", _obj.Order_Layers
            ).xml_data
        ),
        PyPH_WUFI.xml_node.XML_Node(
            *PyPH_WUFI.selection.Selection(
                "Assembly::Grid_Kind", _obj.Grid_Kind
            ).xml_data
        ),
        PyPH_WUFI.xml_node.XML_List(
            "Layers",
            [
                PyPH_WUFI.xml_node.XML_Object("Layer", _, "index", i)
                for i, _ in enumerate(_obj.Layers)
            ],
        ),
    ]
...
def _Polygon(_obj):
    return [
        ...
        PyPH_WUFI.xml_node.XML_List(
            "IdentNrPoints",
            [
                PyPH_WUFI.xml_node.XML_Node("IdentNr", _, "index", i)
                for i, _ in enumerate(_obj.idVert)
            ],
        ),
        PyPH_WUFI.xml_node.XML_List(
            ...
            [
                PyPH_WUFI.xml_node.XML_Node("IdentNr", _, "index", i)
                for i, _ in enumerate(_obj.children)
            ],
        ),
    ]
...
def _Geom(_obj):
    return [
        PyPH_WUFI.xml_node.XML_List(
            "Vertices",
            [
                PyPH_WUFI.xml_node.XML_Object("Vertix", _, "index", i)
                for i, _ in enumerate(_obj.vertices)
            ],
        ),
        PyPH_WUFI.xml_node.XML_List(
            "Polygons",
            [
                PyPH_WUFI.xml_node.XML_Object("Polygon", _, "index", i)
                for i, _ in enumerate(_obj.polygons)
            ],
        ),
    ]
...
def _PH_ClimateLocation(_obj):
    return [
        ...
        PyPH_WUFI.xml_node.XML_Node(
            "HeightNNWeatherStation", _obj.HeightNNWeatherStation
        ),
        PyPH_WUFI.xml_node.XML_Node("Longitude", _obj.Longitude),
        PyPH_WUFI.xml_node.XML_Node("dUTC", _obj.dUTC),
        PyPH_WUFI.xml_node.XML_Node(
            "DailyTemperatureSwingSummer", _obj.DailyTemperatureSwingSummer
        ),
        ...
        PyPH_WUFI.xml_node.XML_Node(
            "GroundThermalConductivity", _obj.GroundThermalConductivity
        ),
        ...
        PyPH_WUFI.xml_node.XML_List(
            ...
            [
                ...
                for i, _ in enumerate(_obj.TemperatureMonthly)
            ],
        ),
        PyPH_WUFI.xml_node.XML_List(
        ...
        PyPH_WUFI.xml_node.XML_List(
            ...
            [
                PyPH_WUFI.xml_node.XML_Node("Item", _, "index", i)
                for i, _ in enumerate(_obj.SkyTemperatureMonthly)
            ],
        ),
        PyPH_WUFI.xml_node.XML_List(
            ...
            [
                PyPH_WUFI.xml_node.XML_Node("Item", _, "index", i)
                for i, _ in enumerate(_obj.GroundTemperatureMonthly)
            ],
        ),
        PyPH_WUFI.xml_node.XML_List(
        ...
        PyPH_WUFI.xml_node.XML_List(
            ...
            [
                PyPH_WUFI.xml_node.XML_Node("Item", _, "index", i)
                for i, _ in enumerate(_obj.EastSolarRadiationMonthly)
            ],
        ),
        PyPH_WUFI.xml_node.XML_List(
        ...
        PyPH_WUFI.xml_node.XML_List(
            ...
            [
                PyPH_WUFI.xml_node.XML_Node("Item", _, "index", i)
                for i, _ in enumerate(_obj.WestSolarRadiationMonthly)
            ],
        ),
        PyPH_WUFI.xml_node.XML_List(
        ...
        PyPH_WUFI.xml_node.XML_Node(
            "NorthSolarRadiationHeating1", _obj.peak_heating_1.rad_north
        ),
        PyPH_WUFI.xml_node.XML_Node(
            "EastSolarRadiationHeating1", _obj.peak_heating_1.rad_east
        ),
        PyPH_WUFI.xml_node.XML_Node(
            "SouthSolarRadiationHeating1", _obj.peak_heating_1.rad_south
        ),
        PyPH_WUFI.xml_node.XML_Node(
            "WestSolarRadiationHeating1", _obj.peak_heating_1.rad_west
        ),
        PyPH_WUFI.xml_node.XML_Node(
            "GlobalSolarRadiationHeating1", _obj.peak_heating_1.rad_global
        ),
        PyPH_WUFI.xml_node.XML_Node("TemperatureHeating2", _obj.peak_heating_2.temp),
        PyPH_WUFI.xml_node.XML_Node(
            "NorthSolarRadiationHeating2", _obj.peak_heating_2.rad_north
        ),
        PyPH_WUFI.xml_node.XML_Node(
            "EastSolarRadiationHeating2", _obj.peak_heating_2.rad_east
        ),
        PyPH_WUFI.xml_node.XML_Node(
            "SouthSolarRadiationHeating2", _obj.peak_heating_2.rad_south
        ),
        PyPH_WUFI.xml_node.XML_Node(
            "WestSolarRadiationHeating2", _obj.peak_heating_2.rad_west
        ),
        PyPH_WUFI.xml_node.XML_Node(
            "GlobalSolarRadiationHeating2", _obj.peak_heating_2.rad_global
        ),
        PyPH_WUFI.xml_node.XML_Node("TemperatureCooling", _obj.peak_cooling.temp),
        PyPH_WUFI.xml_node.XML_Node(
            "NorthSolarRadiationCooling", _obj.peak_cooling.rad_north
        ),
        PyPH_WUFI.xml_node.XML_Node(
            "EastSolarRadiationCooling", _obj.peak_cooling.rad_east
        ),
        PyPH_WUFI.xml_node.XML_Node(
            "SouthSolarRadiationCooling", _obj.peak_cooling.rad_south
        ),
        PyPH_WUFI.xml_node.XML_Node(
            "WestSolarRadiationCooling", _obj.peak_cooling.rad_west
        ),
        PyPH_WUFI.xml_node.XML_Node(
            "GlobalSolarRadiationCooling", _obj.peak_cooling.rad_global
        ),
    ]
...
def _ClimateLocation(_obj):
    return [
        ...
        PyPH_WUFI.xml_node.XML_Node(
            "Unit_CO2concentration", _obj.Unit_CO2concentration
        ),
    ]
...
def _Component(_obj):
    return [
        ...
        PyPH_WUFI.xml_node.XML_Node(
            *PyPH_WUFI.selection.Selection(
                "Component::OuterAttachment", _obj.idEC
            ).xml_data
        ),
        PyPH_WUFI.xml_node.XML_Node(
            *PyPH_WUFI.selection.Selection("Component::Type", _obj.type).xml_data
        ),
        ...
        PyPH_WUFI.xml_node.XML_Node(
            "IdentNr_ComponentInnerSurface", _obj.inner_srfc_compo_idNr
        ),
        PyPH_WUFI.xml_node.XML_List(
            "IdentNrPolygons",
            [
                PyPH_WUFI.xml_node.XML_Node("IdentNr", _, "index", i)
                for i, _ in enumerate(_obj.polygon_id_list)
            ],
        ),
...
def _Space(_obj):
    return [
        ...
        PyPH_WUFI.xml_node.XML_Node(
            *PyPH_WUFI.selection.Selection("WP_Room::Type", _obj.type).xml_data
        ),
        ...
        PyPH_WUFI.xml_node.XML_Node(
            "IdentNrUtilizationPatternVent", _obj.ventilation.utilization_pattern.id
        ),
        PyPH_WUFI.xml_node.XML_Node(
            "IdentNrVentilationUnit", _obj.ventilation.ventilator.id
        ),
        PyPH_WUFI.xml_node.XML_Node(
...
def _Zone(_obj):
    return [
        ...
        PyPH_WUFI.xml_node.XML_Node(
            *PyPH_WUFI.selection.Selection(
                "Zone::GrossVolume_Selection", _obj.volume_gross_selection
            ).xml_data
        ),
        PyPH_WUFI.xml_node.XML_Node("GrossVolume", _obj.volume_gross, "unit"),
        PyPH_WUFI.xml_node.XML_Node(
            *PyPH_WUFI.selection.Selection(
                "Zone::NetVolume_Selection", _obj.volume_net_selection
            ).xml_data
        ),
        PyPH_WUFI.xml_node.XML_Node("NetVolume", _obj.volume_net, "unit"),
        PyPH_WUFI.xml_node.XML_Node(
            *PyPH_WUFI.selection.Selection(
                "Zone::FloorArea_Selection", _obj.floor_area_selection
            ).xml_data
        ),
        PyPH_WUFI.xml_node.XML_Node("FloorArea", _obj.floor_area, "unit"),
        PyPH_WUFI.xml_node.XML_Node(
            *PyPH_WUFI.selection.Selection(
                "Zone::ClearanceHeight_Selection", _obj.clearance_height_selection
            ).xml_data
        ),
        PyPH_WUFI.xml_node.XML_Node(
            "ClearanceHeight", _obj.clearance_height, "unit", "m"
        ),
        PyPH_WUFI.xml_node.XML_Node(
            *PyPH_WUFI.selection.Selection(
        ...
        PyPH_WUFI.xml_node.XML_Node(
            "SpecificHeatCapacity", _obj.spec_heat_cap, "unit", "Wh/m²K"
        ),
        PyPH_WUFI.xml_node.XML_List(
            "RoomsVentilation",
            [
                PyPH_WUFI.xml_node.XML_Object("Room", _, "index", i)
                for i, _ in enumerate(_obj.rooms_ventilation)
            ],
        ),
        PyPH_WUFI.xml_node.XML_List(
            "HomeDevice",
...
def _Building(_obj):
    return [
        ...
        PyPH_WUFI.xml_node.XML_Node(
            "HasBeenChangedSinceLastGeneration", _obj.has_been_changed_since_last_gen
        ),
    ]
...
def _HVAC_PH_Parameters(_obj):
    return [
        PyPH_WUFI.xml_node.XML_Node(
            "HumidityRecoveryEfficiency", _obj.HumidityRecoveryEfficiency
        ),
        PyPH_WUFI.xml_node.XML_Node("ElectricEfficiency", _obj.ElectricEfficiency),
        PyPH_WUFI.xml_node.XML_Node("FrostProtection", _obj.FrostProtection),
        PyPH_WUFI.xml_node.XML_Node("Quantity", _obj.Quantity),
        PyPH_WUFI.xml_node.XML_Node("ElectricEfficiency", _obj.ElectricEfficiency),
        PyPH_WUFI.xml_node.XML_Node(
            "SubsoilHeatExchangeEfficiency", _obj.SubsoilHeatExchangeEfficiency
        ),
        PyPH_WUFI.xml_node.XML_Node(
            "HumidityRecoveryEfficiency", _obj.HumidityRecoveryEfficiency
        ),
        PyPH_WUFI.xml_node.XML_Node("VolumeFlowRateFrom", _obj.VolumeFlowRateFrom),
        PyPH_WUFI.xml_node.XML_Node("VolumeFlowRateTo", _obj.VolumeFlowRateTo),
        PyPH_WUFI.xml_node.XML_Node(
            "TemperatureBelowDefrostUsed", _obj.TemperatureBelowDefrostUsed
        ),
        PyPH_WUFI.xml_node.XML_Node("FrostProtection", _obj.FrostProtection),
        ...
        PyPH_WUFI.xml_node.XML_Node("AuxiliaryEnergy", _obj.AuxiliaryEnergy),
        PyPH_WUFI.xml_node.XML_Node("AuxiliaryEnergyDHW", _obj.AuxiliaryEnergyDHW),
...
def _HVAC_Device(_obj):
    return [
        ...
        PyPH_WUFI.xml_node.XML_Node(
            *PyPH_WUFI.selection.Selection(
                "HVAC_Device::SystemType", _obj.SystemType
            ).xml_data
        ),
        PyPH_WUFI.xml_node.XML_Node(
            *PyPH_WUFI.selection.Selection(
                "HVAC_Device::TypeDevice", _obj.TypeDevice
            ).xml_data
        ),
        ...
        PyPH_WUFI.xml_node.XML_Node(
            "UsedFor_Humidification", _obj.UsedFor_Humidification
        ),
        PyPH_WUFI.xml_node.XML_Node(
            "UsedFor_Dehumidification", _obj.UsedFor_Dehumidification
        ),
        PyPH_WUFI.xml_node.XML_Node(
            "Ventilation_Parameters", _obj.Ventilation_Parameters
        ),
        PyPH_WUFI.xml_node.XML_Node("UseOptionalClimate", _obj.UseOptionalClimate),
        PyPH_WUFI.xml_node.XML_Node(
            "IdentNr_OptionalClimate", _obj.IdentNr_OptionalClimate
        ),
        PyPH_WUFI.xml_node.XML_Object("PH_Parameters", _obj.PH_Parameters),
        PyPH_WUFI.xml_node.XML_Node("HeatRecovery", _obj.HeatRecovery),
        PyPH_WUFI.xml_node.XML_Node("MoistureRecovery", _obj.MoistureRecovery),
    ]
...
def _HVAC_System_ZoneCover(_obj):
    return [
        ...
        PyPH_WUFI.xml_node.XML_Node(
            "CoverageHumidification", _obj.cover_humidification
        ),
        PyPH_WUFI.xml_node.XML_Node(
            "CoverageDehumidification", _obj.cover_dehumidification
        ),
    ]
...
def _HVAC_System(_obj):
    return [
        PyPH_WUFI.xml_node.XML_Node("Name", _obj.n),
        PyPH_WUFI.xml_node.XML_Node(
            *PyPH_WUFI.selection.Selection("HVAC_System::Type", _obj.typeSys).xml_data
        ),
        PyPH_WUFI.xml_node.XML_Node("IdentNr", _obj.id),
        PyPH_WUFI.xml_node.XML_List(
            "ZonesCoverage",
            [
                PyPH_WUFI.xml_node.XML_Object("ZoneCoverage", _, "index", i)
                for i, _ in enumerate(_obj.lZoneCover)
            ],
        ),
        PyPH_WUFI.xml_node.XML_List(
            "Devices",
            [
                PyPH_WUFI.xml_node.XML_Object("Device", _, "index", i)
                for i, _ in enumerate(_obj.lDevice)
            ],
        ),
...
def _HVAC(_obj):
    return [
        PyPH_WUFI.xml_node.XML_List(
            "Systems",
            [
                PyPH_WUFI.xml_node.XML_Object("System", _, "index", i)
                for i, _ in enumerate(_obj.lSystem)
            ],
        ),
    ]
...
def _Project(_obj):
    ...
    return [
        ...
        PyPH_WUFI.xml_node.XML_List(
            "Assemblies",
            [
                PyPH_WUFI.xml_node.XML_Object("Assembly", _, "index", i)
                for i, _ in enumerate(_obj.lAssembly)
            ],
        ),
        PyPH_WUFI.xml_node.XML_List(
            "WindowTypes",
            [
                PyPH_WUFI.xml_node.XML_Object("WindowType", _, "index", i)
                for i, _ in enumerate(_obj.lWindow)
            ],
        ),
