...
def calc_HB_Room_total_ventilation_m3sec(_hb_room):
    ...
    flow_per_ach = (
        _hb_room.properties.energy.ventilation.air_changes_per_hour * _hb_room.volume
    )
    flow_per_area = (
        _hb_room.properties.energy.ventilation.flow_per_area * _hb_room.floor_area
    )
    flow_per_zone = _hb_room.properties.energy.ventilation.flow_per_zone
    room_avg_occupancy = calc_HB_Room_avg_occupancy(_hb_room)
    flow_per_person = (
        _hb_room.properties.energy.ventilation.flow_per_person * room_avg_occupancy
    )
