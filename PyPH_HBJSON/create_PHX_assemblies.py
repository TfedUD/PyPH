...
def create_new_StandardMaterial_from_hb_mat(
    _hb_material: honeybee_energy.material.opaque.EnergyMaterial, _thickness: float
) -> PHX.assemblies.Material:
    """
...
def create_new_assembly_from_hb_face(
    _face: honeybee.face.Face,
) -> PHX.assemblies.Assembly:
...
# --- Windows
# -------------------------------------------------------------------------------
def create_new_window_type_from_hb_face(
    _face: honeybee.face.Face,
...
def set_compo_window_type_from_hb_aperture(
    _window_compo: PHX.component.Component,
    _hb_face: honeybee.face.Face,
    _window_type_collection,
):
