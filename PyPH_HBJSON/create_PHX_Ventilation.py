...
def PHX_ventilation_from_hb_room(_hb_room: honeybee.room.Room):
    ...
    if getattr(_hb_room.properties.energy.ventilation, "user_data", None):
        ...
        print("trying to use the UD Vent Schedule, but I havent writtent part yet")
        ...
        values_high = four_part_sched_values.get(3, {})
        ...
        values_standard = four_part_sched_values.get(2, {})
        ...
        values_basic = four_part_sched_values.get(1, {})
        ...
        values_minimum = four_part_sched_values.get(0, {})
