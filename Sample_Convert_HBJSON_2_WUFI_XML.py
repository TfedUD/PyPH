...
import PyPH_HBJSON.create_PHX_variants
...
for room in hb_model.rooms:
    ...
    host_variant.add_zones(new_zone)
...
for room in hb_model.rooms:
    ...
    for face in room.faces:
        ...
        for aperture in face.apertures:
            ...
            host_variant.add_components(window_compo)

        # -- Pack the new Polygons & Components onto the Variant.
        host_variant.add_components(opaque_compo)
