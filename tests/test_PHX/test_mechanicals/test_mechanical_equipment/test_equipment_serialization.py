...
def test_EquipmentSet_serialization_empty(reset_mech_equipment):
...
def test_EquipmentSet_serialization_with_vent(reset_mech_equipment):
    o1 = PHX.mechanicals.equipment.EquipmentSet()
...
def test_HVAC_Device_serialization(reset_mech_equipment):
...
def test_HVAC_Ventilator_serialization(reset_mech_equipment):
...
def test_HVAC_Ventilator_Default_serialization(reset_mech_equipment):
...
def test_HVAC_Ventilator_PH_Parameters_serialization(reset_mech_equipment):
