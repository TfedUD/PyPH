...
def test_lighting_serialization():
    ...
    d = pattern_1.to_dict()
    pattern_2 = PHX.programs.schedules.Schedule_Lighting.from_dict(d)
...
def test_occupancy_serialization():
    ...
    d = pattern_1.to_dict()
    pattern_2 = PHX.programs.schedules.Schedule_Occupancy.from_dict(d)
...
def test_rates_serialization():
    pattern_1 = PHX.programs.schedules.Vent_UtilRates()
    d = pattern_1.to_dict()
    pattern_2 = PHX.programs.schedules.Vent_UtilRates.from_dict(d)

    assert d == pattern_2.to_dict()


def test_rate_serialization():
    pattern_1 = PHX.programs.schedules.Vent_UtilRate()
    d = pattern_1.to_dict()
    pattern_2 = PHX.programs.schedules.Vent_UtilRate.from_dict(d)

    assert d == pattern_2.to_dict()


def test_vent_serialization():
    pattern_1 = PHX.programs.schedules.Schedule_Ventilation()
    d = pattern_1.to_dict()
    pattern_2 = PHX.programs.schedules.Schedule_Ventilation.from_dict(d)

    assert d == pattern_2.to_dict()


def test_vent_default_serialization():
    pattern_1 = PHX.programs.schedules.Schedule_Ventilation.default()
    d = pattern_1.to_dict()
    pattern_2 = PHX.programs.schedules.Schedule_Ventilation.from_dict(d)
