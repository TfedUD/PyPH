...
def test_vent_duct(reset_vent_components):
    c1 = PHX.hvac_components.HVAC_Duct()
    c2 = PHX.hvac_components.HVAC_Duct()
...
def test_default_vent_duct(reset_vent_components):
    c1 = PHX.hvac_components.HVAC_Duct.default()
    c2 = PHX.hvac_components.HVAC_Duct.default()
...
def test_duct_length(reset_vent_components):
    seg1 = PHX.hvac_components.HVAC_Duct_Segment()
    seg1.length = 12
    seg2 = PHX.hvac_components.HVAC_Duct_Segment()
    seg2.length = 13
    seg3 = PHX.hvac_components.HVAC_Duct_Segment()
    seg3.length = 25
...
def test_sum_ducts(reset_vent_components):
    ...
    seg4 = PHX.hvac_components.HVAC_Duct_Segment()
    seg4.length = 35
    c3 = PHX.hvac_components.HVAC_Duct()
    ...
    c5 = sum((c1, c2, c3), start=PHX.hvac_components.HVAC_Duct())
