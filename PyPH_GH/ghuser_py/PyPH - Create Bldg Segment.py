...
for room in _HB_rooms:
    ...
    new_hb_room = LBT_Utils.user_data.add_to_HB_Obj_user_data(
        new_hb_room, bldg_seg_dict, "bldg_segment_id", _write_mode="overwrite"
    )

    occ_dict = occupancy.to_dict()
    new_hb_room = LBT_Utils.user_data.add_to_HB_Obj_user_data(
        new_hb_room, occ_dict, "segment_occupancy", _write_mode="overwrite"
    )

    ph_param_dict = new_PH_params.to_dict()
    new_hb_room = LBT_Utils.user_data.add_to_HB_Obj_user_data(
        new_hb_room, ph_param_dict, "ph_certification", _write_mode="overwrite"
    )
